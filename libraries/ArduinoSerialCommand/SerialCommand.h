...
Jan 2014 - Modified constructor to accept hardware serial reference in order to use Serial1, Serial2,
           etc. on boards like the Mega and Due - Griffin Adams
...
class SerialCommand
{
	...
	private:
		...
		#endif
        #ifdef SERIALCOMMAND_HARDWAREONLY
        HardwareSerial *_HardSerial;        // Pointer to a user-created HardwareSerial object
        #endif
};
